...
<div>
    ...
    <div class="mt-6">
        <a href="https://github.com/sponsors/lukeraymonddowning"
           class="mx-auto border-teal hover:border-teal-dark hover:bg-teal-dark border-2 rounded px-4 py-3 mx-auto text-teal hover:text-zinc-50 transition">
            Become a Sponsor
        </a>
    </div>
</div>
